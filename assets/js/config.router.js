...
function ($localStorage, $stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $stateProvider.state('app', {
        ...
        resolve: loadSequence('d3', 'ui.knob', 'countTo','ngTable' ,'dashboardCtrl'),
        title: 'Dashboard',
        ncyBreadcrumb: {
            label: 'Dashboard'
        }

    }).state('app.listcompany', {
        url: '/listcompany',
        templateUrl: "assets/views/listcompany.html",
        title: 'ngTable',
        ncyBreadcrumb: {
            label: 'ngTable'
        },
        resolve: loadSequence('ngTable', 'companyCtrl')
    }).state('app.addcompany', {
        url: '/addcompany',
        templateUrl: "assets/views/addcompany.html",
        title: 'Add Company',
        ncyBreadcrumb: {
            label: 'Elements'
        },
        ...
        resolve: loadSequence('ngTable', 'qaCtrl')
    }).state('app.addqa', {
        url: '/addqualityassurance',
        templateUrl: "assets/views/addqualityassurance.html",
        title: 'Add Transcriber',
        ncyBreadcrumb: {
            label: 'Elements'
        },
        resolve: loadSequence('monospaced.elastic', 'ui.mask', 'touchspin-plugin', 'qaCtrl')
    }).state('app.listdoc', {
        url: '/listdoctor',
        templateUrl: "assets/views/listdoctor.html",
        title: 'ngTable',
        ncyBreadcrumb: {
            label: 'ngTable'
        },
        resolve: loadSequence('ngTable', 'doctorCtrl')
    }).state('app.adddoc', {
        url: '/adddoctor',
        templateUrl: "assets/views/adddoctor.html",
        title: 'Add Transcriber',
        ncyBreadcrumb: {
            label: 'Elements'
        },
        resolve: loadSequence('monospaced.elastic', 'ui.mask', 'touchspin-plugin', 'doctorCtrl')
    }).state('app.listnurse', {
        url: '/listnurse',
        templateUrl: "assets/views/listnurse.html",
        title: 'ngTable',
        ncyBreadcrumb: {
            label: 'ngTable'
        },
        resolve: loadSequence('ngTable', 'nurseCtrl')
    }).state('app.addnurse', {
        url: '/addnurse',
        templateUrl: "assets/views/addnurse.html",
        title: 'Add Transcriber',
        ncyBreadcrumb: {
            label: 'Elements'
        },
        resolve: loadSequence('monospaced.elastic', 'ui.mask', 'touchspin-plugin', 'nurseCtrl')
    }).state('app.listpracticeadmin', {
        url: '/listpracticeadmin',
        templateUrl: "assets/views/listpracticeadmin.html",
        title: 'ngTable',
        ncyBreadcrumb: {
            label: 'ngTable'
        },
        resolve: loadSequence('ngTable', 'practiceadminCtrl')
    }).state('app.addpracticeadmin', {
        url: '/addpracticeadmin',
        templateUrl: "assets/views/addpracticeadmin.html",
        title: 'Add Transcriber',
        ncyBreadcrumb: {
            label: 'Elements'
        },
        resolve: loadSequence('monospaced.elastic', 'ui.mask', 'touchspin-plugin', 'practiceadminCtrl')
    }).state('app.listappoinment', {
        url: '/listappoinment',
        templateUrl: "assets/views/listappoinment.html",
        title: 'ngTable',
        ncyBreadcrumb: {
            label: 'ngTable'
        },
        resolve: loadSequence('ngTable', 'appointmentCtrl')
    }).state('app.addappoinment', {
        url: '/addappoinment',
        templateUrl: "assets/views/addappoinment.html",
        title: 'Add Transcriber',
        ncyBreadcrumb: {
            label: 'Elements'
        },
        resolve: loadSequence('monospaced.elastic', 'ui.mask', 'touchspin-plugin', 'appointmentCtrl')
    }).state('app.listreceptionist', {
        url: '/listreceptionist',
        templateUrl: "assets/views/listreceptionist.html",
        title: 'ngTable',
        ncyBreadcrumb: {
            label: 'ngTable'
        },
        resolve: loadSequence('ngTable', 'receptionistCtrl')
    }).state('app.addreceptionist', {
        url: '/addreceptionist',
        templateUrl: "assets/views/addreceptionist.html",
        title: 'Add Transcriber',
        ncyBreadcrumb: {
            label: 'Elements'
        },
        resolve: loadSequence('monospaced.elastic', 'ui.mask', 'touchspin-plugin', 'receptionistCtrl')
    }).state('app.listtrancoadmin', {
        url: '/listadmin',
        templateUrl: "assets/views/listadmin.html",
        title: 'ngTable',
        ncyBreadcrumb: {
            label: 'ngTable'
        },
        ...
        resolve: loadSequence('monospaced.elastic', 'ui.mask', 'touchspin-plugin', 'listtrancoadminCtrl')
