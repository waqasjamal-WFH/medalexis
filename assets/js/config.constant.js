...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'logoutCtrl': 'assets/js/controllers/logoutCtrl.js',
        'companyCtrl': 'assets/js/controllers/companyCtrl.js',
        'listtrancoadminCtrl': 'assets/js/controllers/listtrancoadminCtrl.js',
        'transcriberCtrl': 'assets/js/controllers/transcriberCtrl.js',
        'qaCtrl': 'assets/js/controllers/qaCtrl.js',
        'doctorCtrl': 'assets/js/controllers/doctorCtrl.js',
        'nurseCtrl': 'assets/js/controllers/nurseCtrl.js',
    ...
    modules: [{
        ...
        name: 'ngMaterial',
        files: ['http://ajax.googleapis.com/ajax/libs/angular_material/1.1.0/angular-material.min.css','http://ajax.googleapis.com/ajax/libs/angular_material/1.1.0/angular-material.min.js','http://ajax.googleapis.com/ajax/libs/angularjs/1.5.5/angular-animate.min.js','http://ajax.googleapis.com/ajax/libs/angularjs/1.5.5/angular-aria.min.js','http://ajax.googleapis.com/ajax/libs/angularjs/1.5.5/angular-messages.min.js']
    }]
});