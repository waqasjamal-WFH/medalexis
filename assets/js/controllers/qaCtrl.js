...
app.controller('addqaCtrl', ["$scope","$location",function($scope,$location){
	$scope.name="hello transcriber";
}]);
...
app.controller('listqaCtrl', ["$scope", "$filter", "ngTableParams", function ($scope, $filter, ngTableParams) {
    var data = [{
        "id": 1,
        "lm": 138661285100,
        "ln": "Smith",
