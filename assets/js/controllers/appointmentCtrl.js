...
app.controller('addappointmentCtrl', ["$scope","$location",function($scope,$location){
...
app.controller('listappointmentCtrl', ["$scope", "$filter", "ngTableParams", function ($scope, $filter, ngTableParams) {
    var data = [{
        "id": 1,
        "lm": 138661285100,
        "ln": "Smith",
