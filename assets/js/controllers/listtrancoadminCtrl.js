...
app.controller('addadminCtrl', ["$scope","$location","$http","$localStorage",function($scope,$location,$http,$localStorage){
...
app.controller('listadminCtrl', ["$scope", "$filter", "ngTableParams","$uibModal", "$log", function ($scope, $filter, ngTableParams,$uibModal, $log) {
