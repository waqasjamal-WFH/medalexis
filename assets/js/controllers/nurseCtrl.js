...
app.controller('addnurseCtrl', ["$scope","$location",function($scope,$location){
	$scope.name="hello Nurse";
}]);
...
app.controller('listnurseCtrl', ["$scope", "$filter", "ngTableParams", function ($scope, $filter, ngTableParams) {
    var data = [{
        "id": 1,
        "lm": 138661285100,
        "ln": "Smith",
